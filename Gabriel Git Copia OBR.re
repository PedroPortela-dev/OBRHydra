...
booleano kit = verdadeiro
booleano virvermelho=verdadeiro
booleano ramon=verdadeiro
...
tarefa verde{
	...
	se(cor(2)=="VERDE" ou cor(2)=="CIANO" ou cor(1)=="VERDE" ou cor(1)=="CIANO" e tempo()-timer4>200)entao{
		escrever(1,"intercessão verde")
		enquanto(cor(3)!="VERDE" e cor(3)!="CIANO" e cor(4)!="VERDE" e cor(4)!="CIANO" e luz(4)>sensibilidade+5 e luz(1)>sensibilidade+5)farei{
			seguidordelinha()
		}
		se(cor(3)!="VERDE" e cor(3)!="CIANO" e cor(4)!="VERDE" e cor(4)!="CIANO")entao{
			frente(300)
			enquanto(luz(1)<=sensibilidade+5)farei{}
			frenterotacao(300,5)
		}
	...
	senao se(cor(3)=="VERDE" ou cor(3)=="CIANO" ou cor(4)=="VERDE" ou cor(4)=="CIANO" e tempo()-timer4>200)entao{
		escrever(1,"intercessão verde")
		enquanto(cor(2)!="VERDE" e cor(2)!="CIANO" e cor(1)!="VERDE" e cor(1)!="CIANO" e luz(1)>=sensibilidade e luz(4)>sensibilidade+5)farei{
			seguidordelinha()
		}
		se(cor(2)!="VERDE" e cor(2)!="CIANO" e cor(1)!="VERDE" e cor(1)!="CIANO")entao{
			frente(300)
			enquanto(luz(4)<=sensibilidade+5)farei{}
			frenterotacao(300,5)
		}
...
tarefa idtriangulo{
    ...
    farei{
        ...
        farei{
			se(qqw)entao{
				se(modulo(ultra(num4)-dist2)>teste1)entao{
					teste1=modulo(ultra(num4)-dist2)
					escrever(3,virartexto(teste1))
				}
            	se(modulo(ultra(num4)-dist2)>7)entao{
					qqw=falso
               	}senao{
					dist2=modulo(ultra(num4)-dist2)
				}
            }
	...
	irfrente=falso
		...
		farei{
			se(ultra(num1)<330)entao{
				...
				senao se(dist1-ultra(num1)>6)entao{
                    dist2=ultra(num1)
                    qqw=falso
                }senao{
                    dist1=ultra(num1)
...
tarefa vitpreto{
	...
	frente(300)
	esperar(51)
	escrever(1,virartexto(dist2))
	escrever(2,virartexto(ultra(num1)))
	escrever(3,virartexto(ultra(num1)-dist2))
	tras(300)
